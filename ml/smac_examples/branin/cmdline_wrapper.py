...
To run this example, execute:
    $ cd smac_examples/branin
    $ python ../../scripts/smac --scenario scenario.txt

We optimize the branin-function (see "smac_examples/branin/branin.py").

To use the commandline, we need two files:
- a scenario-file: located in "smac_examples/branin/scenario.txt"
                   specifies SMAC-parameters, e.g. runtime, output, etc.
- a pcs-file:      located in "smac_examples/branin/param_config_space.pcs"
